import{j as l,d as m,H as d}from"./framework.0320c551.js";const f={size:{type:Number},color:{type:String},spin:{type:Boolean},rotate:{type:Number},onClick:{type:Function}},o=`
@keyframes iconSpin {
    from {
        transform: rotate(0);
