import{j as l,d as m,H as d}from"./framework.c15ea7b3.js";const f={size:{type:Number},color:{type:String},spin:{type:Boolean},rotate:{type:Number},onClick:{type:Function}},o=`
@keyframes iconSpin {
    from {
        transform: rotate(0);
